...
parser.add_argument('--epochs', type=int, default=300, help='number of epochs to pretrain')
parser.add_argument('--lr', type=float, default=0.0002, help='learning rate, default=0.0002')
parser.add_argument('--cuda', action='store_true', help='enables cuda')
parser.add_argument('--manualSeed', type=int, help='manual seed')
parser.add_argument('--logdir', default='./log/', help='logdir for tensorboard')
parser.add_argument('--run_tag', default='prep', help='tags for the current run')
